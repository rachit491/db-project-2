...
2. Steps to run code:
Goto SimpleDB in terminal and then type  java simpledb.server.Startup simpleDB
Once the server is ready.
Open Eclipse Project for SimpleDBClient, paste the provided Testing.java file from zip folder.
You need to have 9 txt files named as filename{}.txt ({} - number from 1 to 9), along with the Testing.java
Right click on Testing.java, and run as Application to see final result.
